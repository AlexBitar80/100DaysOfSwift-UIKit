...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .pause, target: self, action: #selector(totalScore))
    ...
    @objc func totalScore() {
        let currentScore = UIAlertController(title: "pontuação atual \(score)", message: "", preferredStyle: .alert)
        
        currentScore.addAction(UIAlertAction(title: "Fechar", style: .default, handler: nil))
        
        present(currentScore, animated: true)
    }
}
